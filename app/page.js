...
export default function Storefront() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] font-sans text-gray-900 relative">
      ...
      {/* BULLETPROOF FLOATING WHATSAPP BUTTON (Uses Native Link) */}
      <a 
        href={`https://api.whatsapp.com/send?phone=${WHATSAPP_NUMBER}&text=${encodeURIComponent("Hi! I have a general inquiry about your wholesale catalog.")}`}
        target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex space-x-6 items-center font-semibold text-sm tracking-wide">
              ...
              <a 
                href={`https://api.whatsapp.com/send?phone=${WHATSAPP_NUMBER}&text=${encodeURIComponent("I'd like to partner with Kamakhya Trading Co.")}`}
                target="_blank"
                rel="noopener noreferrer"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-8 gap-y-16">
          {filteredProducts.map((product) => {
            ...
            // Generate the exact pre-filled WhatsApp link for this specific product and color
            ...
            return (
              <div key={product.id} className="group relative flex flex-col bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100">
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  {/* BULLETPROOF WHATSAPP LINK BUTTON */}
                  <a 
                    href={productWaUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full bg-[#25D366] hover:bg-[#1EBE5A] text-white font-bold py-3.5 px-4 rounded-xl transition-colors duration-300 flex items-center justify-center space-x-2 shadow-lg shadow-green-500/20"
                  >
